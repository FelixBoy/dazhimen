...
<div  style="width: 380px;margin: 0 auto;">
    <form id="modifyNewsMainimgForm" action="<%=request.getContextPath()%>/news/saveModifyNewsMainImg"
        ...
        <table cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="easyui-filebox" id="mainImgInModifyNewsTitleDialog" name="mainimgmodify" style="width:280px" accept="image/jpeg,image/png"
